...
The message space is the set $\mathbb{Z}_{2^8}^N$. In other words, we put one byte on each coefficient of the polynomial. Messages should be encoded in the eight *least significant bits* when given to the encryption function.
